# Book Recommendation System + AI Reading Assistant 
A data engineering project mapped to a real Data Engineer job:
— PySpark, 
— Delta Lake, 
— Scikit-learn
— Claude-powered AI assistant, built on the goodbooks-10k dataset. 
